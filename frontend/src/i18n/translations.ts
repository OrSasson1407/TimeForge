...
const dictionary = {
  ...
  'collab.alsoViewing': { en: 'Also here:', he: 'נמצאים גם:' },
  'collab.onlyYou': { en: 'Only you are viewing this version.', he: 'רק אתם צופים בגרסה זו.' },
  'analytics.title': { en: 'Analytics', he: 'אנליטיקה' },
  'analytics.subtitle': {
    en: 'Workload balance, room utilization, and curriculum coverage for a schedule version.',
    he: 'איזון עומסים, ניצול חדרים וכיסוי תוכנית הלימודים עבור גרסת מערכת שעות.',
  },
  'analytics.selectVersion': { en: 'Version', he: 'גרסה' },
  'analytics.select': { en: 'Select…', he: 'בחרו…' },
  'analytics.noVersions': {
    en: 'Generate a schedule first — there is nothing to analyze yet.',
    he: 'צרו מערכת שעות תחילה — אין עדיין מה לנתח.',
  },
  'analytics.selectToAnalyze': {
    en: 'Select a version to analyze.',
    he: 'בחרו גרסה לניתוח.',
  },
  'analytics.errorLoading': {
    en: 'Could not load analytics.',
    he: 'לא ניתן היה לטעון את הנתונים.',
  },
  'analytics.totalAssignments': { en: 'Scheduled lessons', he: 'שיעורים משובצים' },
  'analytics.weeklySlots': { en: 'Weekly slots', he: 'משבצות שבועיות' },
  'analytics.workloadSpread': { en: 'Workload spread', he: 'פיזור עומסים' },
  'analytics.workloadSpreadHint': {
    en: 'Standard deviation of periods per teacher — lower is more evenly shared.',
    he: 'סטיית תקן של שיעורים למורה — נמוך יותר משמעו חלוקה שוויונית יותר.',
  },
  'analytics.teacherWorkload': { en: 'Teacher workload', he: 'עומס מורים' },
  'analytics.teacher': { en: 'Teacher', he: 'מורה' },
  'analytics.periods': { en: 'Periods', he: 'שיעורים' },
  'analytics.maxLoad': { en: 'Max load', he: 'עומס מרבי' },
  'analytics.share': { en: 'Share of max', he: 'אחוז מהמרבי' },
  'analytics.roomUtilization': { en: 'Room utilization', he: 'ניצול חדרים' },
  'analytics.room': { en: 'Room', he: 'חדר' },
  'analytics.used': { en: 'Used', he: 'בשימוש' },
  'analytics.available': { en: 'Available', he: 'זמין' },
  'analytics.utilization': { en: 'Utilization', he: 'ניצול' },
  'analytics.closed': { en: 'Closed', he: 'סגור' },
  'analytics.classCoverage': { en: 'Curriculum coverage', he: 'כיסוי תוכנית הלימודים' },
  'analytics.class': { en: 'Class', he: 'כיתה' },
  'analytics.scheduled': { en: 'Scheduled', he: 'שובצו' },
  'analytics.required': { en: 'Required', he: 'נדרשים' },
  'analytics.complete': { en: 'Complete', he: 'הושלם' },
  'analytics.incomplete': { en: 'Short', he: 'חסר' },
